...
items <- lapply(cells, function(n) {
  generate_puzzle(type = "voronoi", grid = c(n), size = c(200, 200), seed = 42)
})
...
items <- lapply(offsets, function(off) {
  generate_puzzle(type = "voronoi", grid = c(20), size = c(200, 200), seed = 42, offset = off)
})
...
items <- lapply(seeds, function(s) {
  generate_puzzle(type = "voronoi", grid = c(15), size = c(200, 200), seed = s)
})
