...
make_vor_cells(10) + make_vor_cells(25) + make_vor_cells(50)
```
...
(make_vor_palette("viridis") + make_vor_palette("magma") + make_vor_palette("plasma")) /
...
make_vor_offset(0) + make_vor_offset(5) + make_vor_offset(10) + make_vor_offset(20)
```
...
make_vor_seed(1) + make_vor_seed(42) + make_vor_seed(123) + make_vor_seed(999)
```
