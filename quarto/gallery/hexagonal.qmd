...
print(render_puzzle_preview(result_2) + labs(title = "2 rings"))
...
print(render_puzzle_preview(result_3) + labs(title = "3 rings"))
...
print(render_puzzle_preview(result_4) + labs(title = "4 rings"))
```
