...
make_rand_pieces(10) + make_rand_pieces(20) + make_rand_pieces(40)
```
...
make_rand_corners(3, "3 corners") + make_rand_corners(4, "4 corners") +
...
(make_rand_palette("viridis") + make_rand_palette("magma") + make_rand_palette("plasma")) /
...
make_rand_offset(0) + make_rand_offset(5) + make_rand_offset(10) + make_rand_offset(20)
```
...
make_rand_seed(1) + make_rand_seed(42) + make_rand_seed(123) + make_rand_seed(999)
```
