...
items <- lapply(corners, function(nc) {
  generate_puzzle(type = "random", grid = c(15), size = c(200, 200), seed = 42, n_corner = nc, fill_palette = "plasma")
})
...
items <- lapply(palettes, function(pal) {
  generate_puzzle(type = "random", grid = c(20), size = c(200, 200), seed = 42, fill_palette = pal)
})
...
Control the spatial order of color assignment. This is distinct from `palette_invert` which reverses the dark↔light ends of the palette.
...
items <- lapply(directions, function(dir) {
  generate_puzzle(type = "random", grid = c(15), size = c(200, 200), seed = 42, fill_palette = "viridis", fill_direction = dir)
})
...
items <- lapply(offsets, function(off) {
  generate_puzzle(type = "random", grid = c(18), size = c(200, 200), seed = 42, offset = off, fill_palette = "cividis")
})
...
items <- lapply(seeds, function(s) {
  generate_puzzle(type = "random", grid = c(15), size = c(200, 200), seed = s, fill_palette = "turbo")
})
