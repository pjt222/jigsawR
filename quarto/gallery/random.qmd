...
items <- lapply(counts, function(n) {
  generate_puzzle(type = "random", grid = c(n), size = c(200, 200), seed = 42)
})
...
items <- lapply(corners, function(nc) {
  generate_puzzle(type = "random", grid = c(15), size = c(200, 200), seed = 42, n_corner = nc)
})
...
items <- lapply(offsets, function(off) {
  generate_puzzle(type = "random", grid = c(18), size = c(200, 200), seed = 42, offset = off)
})
...
items <- lapply(seeds, function(s) {
  generate_puzzle(type = "random", grid = c(15), size = c(200, 200), seed = s)
})
