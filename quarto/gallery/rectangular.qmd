...
#|   - "cividis"
#|   - "turbo"
# API with fill_palette for colored fills matching ggpuzzle aesthetics
for (pal in c("viridis", "magma", "plasma", "inferno", "cividis", "turbo")) {
  result <- generate_puzzle(
    ...
    size = c(400, 300),
    seed = 42,
    fill_palette = pal  # Fills pieces with palette colors
  )
  print(render_puzzle_preview(result))
}
```
