...
Generate stunning, mathematically precise jigsaw puzzles with ease.
Five puzzle types, infinite possibilities. {.hero-subtitle}
:::
...
[Get Started](getting-started.qmd){.btn .btn-lg .btn-primary}
[View on GitHub](https://github.com/pjt222/jigsawR){.btn .btn-lg .btn-outline-secondary}
:::
